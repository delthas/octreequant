...
//
// Images are quantized (converted) using the Octree Color Quantization algorithm,
// which is the fastest, but provides slightly worse results, quality-wise, than
// a median cut clustering quantizer, or a brute-force quantizer.
package octreequant
